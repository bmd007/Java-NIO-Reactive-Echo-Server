...
public class ReactoreServer implements Runnable {
    ...
    ReactoreServer(int port) throws IOException {
    ...
    public static void main(String[] args) {
        ...
        try {
            new Thread(new ReactoreServer(8000)).start(); // a single thread blocking on selector for events
        } catch (IOException ex) {
            ex.printStackTrace();
        }
    }
